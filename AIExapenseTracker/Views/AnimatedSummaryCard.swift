...
struct AnimatedSummaryCard: View {
    ...
    init(title: String, value: Double, showCents: Bool = false, format: FloatingPointFormatStyle<Double>.Currency,
    ...
    private func formatWithoutCents(_ value: Double) -> String {
